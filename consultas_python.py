...
def duplicar_lista(numeros):
    """
    Duplica cada valor en una lista de números usando la función map().

    Args:
        numeros (list): Lista de números.

    Returns:
        list: Nueva lista con el doble de cada valor.
    """
...
if __name__ == "__main__":
    ...
    # Obtener la nueva lista con valores duplicados
    lista_duplicada = duplicar_lista(lista_numeros)
...
def tuplas_a_strings(lista_tuplas):
    ...
    Returns:
        list: Lista de strings generada a partir de las tuplas.
    """
...
def longitudes_palabras(frase):
    ...
    """
    # Dividir la frase en palabras y calcular la longitud de cada palabra
...
if __name__ == "__main__":
    ...
    # Obtener la lista de longitudes
    longitudes = longitudes_palabras(frase_ejemplo)
...
def estudiantes_destacados(estudiantes):
    """
    Filtra a los estudiantes con una calificación mayor o igual a 90.

    Args:
        estudiantes (list): Lista de diccionarios con información de los estudiantes.

    Returns:
        list: Lista de diccionarios con los estudiantes destacados.
    """
...
if __name__ == "__main__":
    ...
    # Filtrar estudiantes destacados
...
def filtrar_enteros(lista):
    """
    Filtra los elementos de tipo int de una lista.

    Args:
        lista (list): Lista con elementos de diferentes tipos.

    Returns:
        list: Lista con solo los elementos de tipo int.
    """
...
if __name__ == "__main__":
    ...
    # Filtrar valores enteros
    lista_enteros = filtrar_enteros(lista_mixta)
...
def producto_total(lista_numeros):
    ...
    Returns:
        int/float: Producto total de los valores en la lista.
    """
    if not lista_numeros:
...
def concatenar_palabras(lista_palabras):
    """
    Concatena las palabras de una lista en una sola cadena.

    Args:
        lista_palabras (list): Lista de palabras (strings).

    Returns:
        str: Cadena resultante de la concatenación de todas las palabras.
    """
...
def diferencia_total(lista_numeros):
    """
    Calcula la diferencia total en los valores de una lista numérica.

    Args:
        lista_numeros (list): Lista de números.

    Returns:
        int/float: Resultado de la diferencia total.

    Raises:
        ValueError: Si la lista tiene menos de dos elementos.
    """
    if len(lista_numeros) < 2:
        raise ValueError("La lista debe contener al menos dos números para calcular la diferencia total.")

    # Usar reduce para calcular la diferencia total
    return reduce(lambda x, y: x - y, lista_numeros)
